...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<metaproperty="og:image"content="http://www.zeli.cf/images/cart.png">
	<meta property="og:url" content="http://www.zeli.cf/"/>
	<meta property="og:type" content="Tienda"/>
	
	<meta name="theme-color" content="#367FA9"/>
  
  <title>Administrar ZeliTech</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="./" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Zeli</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="dist/img/avatarwilian.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/avatarwilian.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=nombre_admin_dash()?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?=nombre_admin_dash()?> - Web Developer
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="?p=manejar_traking">
            <i class="fa fa-th"></i> <span>Manejar Traking</span>
          </a>
        </li>
      </ul>
    </section>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="dist/img/avatarwilian.jpg" alt="user image" class="offline">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?=date("Y")?> <a href="http://zeli.cf">ZeliTech</a>.</strong> All rights
    reserved.
  </footer>
